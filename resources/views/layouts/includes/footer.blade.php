        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2018 &copy;
                <a href="#" title="Concord Pharmaceuticals" target="_blank">Concord Pharmaceuticals</a>
            </div>
        ...
        <script src="{{ asset('assets/global/plugins/spectrum/spectrum.js') }}" type="text/javascript"></script>
        <!-- END CORE PLUGINS -->
        ...
        <!--script src="{{ asset('assets/global/plugins/datatables-theme/datatables.all.min.js') }}"></script-->
        <script src="https://cdn.datatables.net/1.10.12/js/jquery.dataTables.min.js"></script>

        <script src="{{ asset('assets/custom/js/datatables.js') }}"></script>
        ...
        <script src="{{ asset('assets/custom/js/double_scroll.js') }}"></script> 
        <script src="{{ asset('assets/custom/js/jquery.table2excel.min.js') }}"></script>
