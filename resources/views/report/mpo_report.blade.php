	      			...
	      			<div class="portlet light bordered">
						<div class="portlet-title">
				            <div class="caption">
				                ...
				                <span class="caption-subject font-dark bold uppercase"><i class="fa fa-table"></i> MPO DCR</span>
				            </div>
																		...
																		<tr>
																			...
																			<td>
															                    <div class="form-group form-md-line-input pull-right" style="max-width: 300px; margin-bottom: 0;">
																					<form id="date_filter_form" method="post" action="{{ url('mpo_report',$user_details->id) }}">
																					{{ csrf_field() }}
														...
														<table class="border-table">
															<thead>
																<tr>
																    ...
																    <td>Cash<br>(TK)</td>
																    <td>Credit<br>(TK)</td>
																    <td>Collection<br>(TK)</td>
																    <td>Commitment/ Remark</td>
																</tr>
															</thead>
			...
			<tr>
				<td class="header container" >
					<div class="content">
						...
						<div style="color: #000; text-align: center;margin: 0 auto 10px auto;">Medical Promotional Officer</div>
							...
							<table class="border-table">
								<thead>
									<tr>
									    ...
									    <td rowspan="2" style="text-align: center;">Time</td>
									    <td  rowspan="2" width="100px">Doctor Name</td>
									    <td rowspan="2">Contact<br>Number</td>
									    <td rowspan="2">Qualification</td>
									    <td rowspan="2">Speciality</td>
									    <td rowspan="2">Class<br>(A,B,C)</td>
									    <td rowspan="2" width="100px">Visited With</td>
									...
									<tr>
									    ...
									    <th scope="col" style="width: 50px;">Sample</th>
									    <th scope="col" style="width: 50px;">Ppm</th>
									    <th scope="col" style="width: 50px;">Gift</th>
									</tr>
								</thead>
